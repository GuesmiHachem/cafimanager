...
<header class="header">
	<div class="page-brand">
		<a class="link" href="index-2.html"> <span class="brand">Cafi
				<span class="brand-tip">Manager</span>
		</span> <span class="brand-mini">CM</span>
		</a>
	</div>
	<div class="flexbox flex-1">
		...
		<ul class="nav navbar-toolbar">
			...
			<li class="dropdown dropdown-user"><select id="locales"
			...
			<li class="dropdown dropdown-user"><a
				class="nav-link dropdown-toggle link" data-toggle="dropdown"><span></span>Langue<i
			...
			<li class="dropdown dropdown-user"><a
				class="nav-link dropdown-toggle link" data-toggle="dropdown"> <img
					src="../../assets/img/admin-avatar.png" /> <span></span>Admin<i
					class="fa fa-angle-down m-l-5"></i></a>
				<ul class="dropdown-menu dropdown-menu-right">
